...
The decision is yours. I made sure nothing important was missing when you made it.` },
  ...
  function appendWritingBar(contentDiv) {
    ...
    el.innerHTML =
      `<svg class="bcp-hammer-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">` +
      `<rect x="8" y="3" width="14" height="7" rx="1.5" fill="#858585"/>` +
      `<rect x="10.5" y="9" width="3.5" height="12" rx="1.5" fill="#858585"/>` +
